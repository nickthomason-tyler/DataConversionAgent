...
A working Phase-1 scaffold of the guidance agent lives in [`/agent`](../../agent/README.md) — runnable code, sample DCT dictionary, per-client project context, and the eval harness.
